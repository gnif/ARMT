...
FCT_BGN()
{
    ...
    FCT_SUITE_BGN(test_suite_rsa)
    {
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_1)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA1, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_VERIFY_FAILED );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_2)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA1, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA1_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_4)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA224, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_5)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA256, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA2_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_6)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA384, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_7)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA384, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA4_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_8)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA512, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA4_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_10)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA1, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA1_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_22)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA224, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA2_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_30)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA256, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA2_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_verify_v15_cavs_33)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_SHA512, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
#endif /* POLARSSL_SHA4_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_1_sha512_1536_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_SHA512, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_2_sha256_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_SHA256, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_3_sha224_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_SHA224, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_4_sha384_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_SHA384, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_5_md2_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_MD2, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_5_verify)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_MD2, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
#endif /* POLARSSL_MD2_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_6_md4_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_MD4, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_6_verify)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_MD4, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
#endif /* POLARSSL_MD4_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_7_md5_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_MD5, 0, hash_result, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_7_verify)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_MD5, 0, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
#endif /* POLARSSL_MD5_C */
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_raw_2048_bits_rsa)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_RAW, hash_len, hash_result, output ) == 0 );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_verify)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_RAW, hash_len, hash_result, result_str ) == 0 );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_verify_wrong_raw_hash)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_RAW, hash_len, hash_result, result_str ) == POLARSSL_ERR_RSA_VERIFY_FAILED );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_9_invalid_digest_type)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, 1, 0, hash_result, output ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_9_verify_invalid_digest_type)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, 1, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_invalid_padding_type)
        {
            ...
            fct_chk( rsa_pkcs1_sign( &ctx, NULL, NULL, RSA_PRIVATE, SIG_RSA_MD5, 0, hash_result, output ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        ...
        FCT_TEST_BGN(rsa_pkcs1_sign_8_verify_invalid_padding_type)
        {
            ...
            fct_chk( rsa_pkcs1_verify( &ctx, RSA_PUBLIC, SIG_RSA_MD5, 0, hash_result, result_str ) == POLARSSL_ERR_RSA_INVALID_PADDING );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(rsa_pkcs1_decrypt_1_verify)
        {
            ...
            fct_chk( rsa_pkcs1_decrypt( &ctx, RSA_PRIVATE, &output_len, message_str, output, 1000 ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_decrypt_2_data_too_small)
        {
            ...
            fct_chk( rsa_pkcs1_decrypt( &ctx, RSA_PRIVATE, &output_len, message_str, output, 1000 ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
            if( POLARSSL_ERR_RSA_BAD_INPUT_DATA == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_decrypt_3_invalid_padding_mode)
        {
            ...
            fct_chk( rsa_pkcs1_decrypt( &ctx, RSA_PRIVATE, &output_len, message_str, output, 1000 ) == POLARSSL_ERR_RSA_INVALID_PADDING );
            if( POLARSSL_ERR_RSA_INVALID_PADDING == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_pkcs1_decrypt_4_output_buffer_too_small)
        {
            ...
            fct_chk( rsa_pkcs1_decrypt( &ctx, RSA_PRIVATE, &output_len, message_str, output, 15 ) == POLARSSL_ERR_RSA_OUTPUT_TOO_LARGE );
        ...
        FCT_TEST_BGN(rsa_check_private_key_7_incorrect)
        {
            rsa_context ctx;
        ...
        FCT_TEST_BGN(rsa_private_correct)
        {
            ...
            fct_chk( rsa_private( &ctx, message_str, output ) == 0 );
            if( 0 == 0 )
            {
                hexify( output_str, output, ctx.len );
        ...
        FCT_TEST_BGN(rsa_private_data_larger_than_n)
        {
            ...
            fct_chk( rsa_private( &ctx, message_str, output ) == POLARSSL_ERR_RSA_BAD_INPUT_DATA );
            if( POLARSSL_ERR_RSA_BAD_INPUT_DATA == 0 )
            {
                hexify( output_str, output, ctx.len );
