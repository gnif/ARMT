...
FCT_BGN()
{
    ...
    FCT_SUITE_BGN(test_suite_version)
    {
        ...
        FCT_TEST_BGN(check_compiletime_library_version)
        {
            ...
            fct_chk( strcmp( "1.1.4", POLARSSL_VERSION_STRING ) == 0 );
        }
        FCT_TEST_END();
        ...
        FCT_TEST_BGN(check_runtime_library_version)
        {
            ...
            snprintf( build_str, 100, "%d.%d.%d",
                ...
                (get_int >> 16) & 0xFF,
                (get_int >> 8) & 0xFF );
            snprintf( build_str_full, 100, "PolarSSL %s", "1.1.4" );
        
            fct_chk( strcmp( build_str, "1.1.4" ) == 0 );
            fct_chk( strcmp( build_str_full, get_str_full ) == 0 );
            fct_chk( strcmp( "1.1.4", get_str ) == 0 );
        }
        FCT_TEST_END();
