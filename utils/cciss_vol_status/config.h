...
/* 1 if FreeBSD ciss driver ioctl header file present */
/* #undef HAVE_CISSIO_H */
...
/* 1 if Linux cciss driver ioctl header file present */
...
/* 1 if Linux SCSI header file present */
#define HAVE_SCSI_SCSI_H 1

/* 1 if Linux SCSI Generic header file present */
...
#define PACKAGE_STRING "cciss_vol_status 1.10"
