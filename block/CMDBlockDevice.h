...
#ifndef _IMDBLOCKDEVICE_H_
#define _IMDBLOCKDEVICE_H_

#include "IBlockDevice.h"

class CMDBlockDevice : public IBlockDevice
{
  public:
    CMDBlockDevice(const std::string &device, const std::string &node);

    static void Enumerate(IBlockDevice::Map &map);

    virtual const char        *GetType        () { return "MD"      ; }
